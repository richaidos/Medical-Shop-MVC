...
namespace Medical_Shop_MVC.Controllers
{
    public class MedicinesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MedicineID,Name,Description,Quantity,MedicineCode")] Medicine medicine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MedicineID,Name,Description,Quantity,MedicineCode")] Medicine medicine)
        {
